...
const Index = () => {
  ...
  useEffect(() => {
    if (!user && !authLoading && messages.length > 2) {
  ...
  }, [user, authLoading, messages.length]);
  ...
  const handleReset = () => {
    ...
    // Reset conversation context for first-time user experience
    resetConversationContext();
          ...
          <div className="flex-1 flex items-center justify-center p-4">
            ...
            >
              <div className="mb-6">
                ...
                <h2 className="text-2xl font-bold text-white mb-2">Welcome to Flight Friend</h2>
                <p className="text-white/80">Please sign in to start chatting with our AI assistant and access your flight search history.</p>
              </div>
              <AuthButtons />
            </motion.div>
          </div>
